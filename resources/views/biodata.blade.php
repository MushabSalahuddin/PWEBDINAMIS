    ...
    <textarea rows="5" cols="20" id="text" name="text"> 
                Nama___________Mush'ab Salahuddin
                TTL____________4 Oktober 1999 
                Kota___________Amuntai
                Pendidikan_______S1 Informatika Universitas Muhammdiyah Banjarmasin
                Alamat_________Jl.Trans Kalimantan Komplek Batola Residence Blok B.43
                Hobby__________Sepak bola, Game, Futsal                       
    </textarea>
    </center>
    
    <center><object data="http://flash-mp3-player.net/medias/player_mp3.swf" width="0" height="0" type="application/x-shockwave-flash"><param value="#ffffff" name="bgcolor" /><center></object><object data="http://flash-mp3-player.net/medias/player_mp3.swf" width="0" height="0" type="application/x-shockwave-flash"><param value="#ffffff" name="bgcolor" /><param value="mp3=http://tux101010.vv.si/Depapepe%20-%20Wedding%20bell.mp3
    &loop=1&autoplay=1&volume=125" name="FlashVars" /></object>
    <script type="text/javascript" 
    
    src="http://script-seo.googlecode.com/files/salju.js"></script>
